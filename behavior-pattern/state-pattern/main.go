...
import (
    "fmt"
    "github.com/BingguWang/design-pattern-study/behavior-pattern/state-pattern/event"
    "github.com/BingguWang/design-pattern-study/behavior-pattern/state-pattern/fsm"
    "github.com/BingguWang/design-pattern-study/behavior-pattern/state-pattern/status"
